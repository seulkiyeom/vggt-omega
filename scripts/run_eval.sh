...
set -euo pipefail
G=$1; shift
R=/NHNHOME/nota/skyeom/projects/vggt_omega_vla
...
exec env \
  ...
  PYTHONPATH=$R/src:/NHNHOME/nota/skyeom/projects/vggt_omega_ref:/NHNHOME/WORKSPACE/SDV_LGE_A/nota/marcel/envs/vga_eval/LIBERO \
  HF_HUB_OFFLINE=1 \
  "${@/#python/$VP}"
